...
//using DoctorAppointmentDemo.Data.Interfaces;
//using MyDoctorAppointment.Service.Services;
//using DoctorAppointmentDemo.Service.Interfaces.Data;
...
//            // Set up serializers for doctor, patient, and appointment data
//            IDataSerializerService<Doctor> doctorSerializer;
//            IDataSerializerService<Patient> patientSerializer;
//            IDataSerializerService<Appointment> appointmentSerializer;

//            switch (dataChoice)
//            {
//                case "1":  // JSON
//                    doctorSerializer = new JsonDataSerializerService<Doctor>();
//                    patientSerializer = new JsonDataSerializerService<Patient>();
//                    appointmentSerializer = new JsonDataSerializerService<Appointment>();
//                    break;

//                case "2":  // XML
//                    doctorSerializer = new XmlDataSerializerService<Doctor>();
//                    patientSerializer = new XmlDataSerializerService<Patient>();
//                    appointmentSerializer = new XmlDataSerializerService<Appointment>();
//                    this.DataFormat = "XML";
//                    break;

//                default:  // Default to JSON if invalid option
//                    doctorSerializer = new JsonDataSerializerService<Doctor>();
//                    patientSerializer = new JsonDataSerializerService<Patient>();
//                    appointmentSerializer = new JsonDataSerializerService<Appointment>();
//                    Console.WriteLine("By default, data is saved in the JSON format.");
