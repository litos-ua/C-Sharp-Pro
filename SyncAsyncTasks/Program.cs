using System.Threading.Tasks;
 ...
 /*  Используем тред пул (синхронная и асинхронная задачи)*/
class Program
{
    static async Task Main()
    {
        ...
        Task.WaitAll(taskFibonacci);
        long fibonacciResult = taskFibonacci.Result;
...
///* Используем стандартный поток для синхронной задачи и тред пул для асинхронной */
//class Program
//{
//    static async Task Main()
//    {
...
//        // Создаем поток для вычисления числа Фибоначчи
//        long fibonacciResult = 0;
//        Thread fibonacciThread = new Thread(() =>
//        {
//            fibonacciResult = MathOperations.Fibonacci(number2);
//        });
