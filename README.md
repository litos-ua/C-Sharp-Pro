...
- Есть парикмахерская, в которой работает один парикмахер (одно кресло для стрижки).
- В парикмахерской есть три кресла для ожидания;
- В начале рабочего дня: программа выводит сообщение о начале работы. 
- В начале дня клиентов нет и парикмахер (Barber) изначально засыпает в ожидании первого
  клиента.
- В течение рабочего дня приходит 10 клиентов. Сначала приходит 5 клиентов, потом есть 
  пауза, после корой приходят остальные 5 клиентов.  Первый клиент будит парикмахера,
  после чего занимает кресло для стрижки и парикмахер его стрижет. Остальные занимают 
  очередь, и три из них могут расположиться в зале ожидания.
- Если клиент будит парикмахера, то выводится сообщение о пробуждении парикмахера
  клиентом.
- В процессе стрижки выводится соответствующее сообщение.
- Клиент (Customer) проверяет наличие мест в зале ожидания. Если мест нет (все три кресла
  заняты), он уходит, и выводится сообщение о его уходе.
- Если место есть, клиент становится в очередь, если парикмахер спит, клиент будит его.
- Парикмахер проверяет, есть ли клиенты в очереди. Если очередь пуста, парикмахер 
  засыпает, и выводится соответствующее сообщение.
- Если клиент ожидает, парикмахер пересаживает его в свое кресло и начинает стрижку.
- После стрижки счетчик (haircutedClientCount) увеличивается на 1.
- Всего в день приходит 10 клиентов, т. е. когда счетчик (haircutedClientCount) 
  достигает 10, парикмахер завершает работу и выводится соответствующее сообщение.
